...
def doInference(sim_truth_catalog, sim_truth_matched_catalog, sim_obs_catalog, real_obs_catalog, lambda_reg = .01, tag='data',
                doplot = False, obs_bins = None, truth_bins = None, savename=None):
    # --------------------------------------------------
